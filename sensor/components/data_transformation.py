...
from sensor.constant.training_pipeline import TAGRET_COLUMN
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,) -> DataTransformationArtifact:
        try:
            ...
            #training dataframe
            input_feature_train_df = train_df.drop(columns=[TAGRET_COLUMN], axis=1)
            target_feature_train_df = train_df[TAGRET_COLUMN]
            target_feature_train_df = target_feature_train_df.replace( TargetValueMapping().to_dict())

            #testing dataframe
            input_feature_test_df = test_df.drop(columns=[TAGRET_COLUMN], axis=1)
            target_feature_test_df = test_df[TAGRET_COLUMN]
